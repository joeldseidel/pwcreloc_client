...
<body>
    <div class="row mt-3">
        <div class="col-md-4">
            <form id="createheuristicform" class="p-3 m-2" action="./php/create_heuristic.php" method="get" style="height:350px;">
                <h2 class="pb-3">Create New Heuristic</h2>
                <div class="form-group">
                    <label for="demo_key_select">Demographic Data:</label>
                    <select class="form-control" name="demo_key_select">
        ...
        <div class="col-md-8">
            <div class="container pt-3 mt-2" id="heuristic_listing_cont">
                <h2>Existing Heuristics</h2>
                <div class="row p-3" id="table_cont">
                    <table class="table table-striped" id="heuristics_table">
                        <thead class = "w-100">
                        <tr>
                            <th>Demographic</th>
                            <th>Preference</th>
                        ...
                        <tbody class="w-100" id = "heuristic_table">
                        </tbody>
                    </table>
                </div>
            </div>
